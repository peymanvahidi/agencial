...
autonomous: true
requirements: [CHART-01, CHART-02, CHART-07, CHART-08]

must_haves:
  truths:
    - "Chart types, timeframes, and OHLC data shapes are fully typed"
    - "Mock data generator produces consistent, realistic OHLCV data for any symbol and timeframe"
    - "Heikin-Ashi transform produces correct HA candles from standard OHLC data"
    - "Chart store holds active symbol, timeframe, chart type, and scale mode"
  artifacts:
...
1. Create `frontend/src/lib/mock-data.ts`:
   ...
   - `getBarCount(timeframe: Timeframe): number` -- returns reasonable bar count per timeframe (1m: 1440 (1 day), 5m: 1440 (5 days), 15m: 1440, 1H: 720 (30 days), 4H: 720 (120 days), 1D: 1000 (~3 years), 1W: 260 (5 years), 1M: 120 (10 years))
